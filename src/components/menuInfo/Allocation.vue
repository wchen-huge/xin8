<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <template>
        <el-table :data="getInveList" border stripe style="width: 100%">
          <el-table-column prop="supName" label="物资名称" align="center"></el-table-column>
          <el-table-column prop="speModel" label="物资规格" align="center"></el-table-column>
          <el-table-column prop="unit" label="单位" align="center"></el-table-column>
          <el-table-column prop="stoQuantity" label="数量" align="center"></el-table-column>
